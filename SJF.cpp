...
class SJF_Scheduling{
    ...
    void schedule(){
        ...
        priority_queue<Process*, vector<Process*>, Heap_comparator> ready_queue;
...
int main(){
    ...
    SJF_Scheduling sjf_scheduler(process_list);
    
    sjf_scheduler.schedule();
    sjf_scheduler.calculate_metrics();

    sjf_scheduler.print_table();
    sjf_scheduler.print_matrices();
    sjf_scheduler.print_gantt_chart();
